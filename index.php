...
<body cz-shortcut-listen="true">
	...
	<div class="orb-wrapper">
		...
		<div class="orb-loader-frame">
			<div class="orb-loader orb-active">
		...
		<!-- page loader end -->
		<div id="orb-dynamic-content" class="transition-fade" data-swup="0">
						...
						<div class="orb-g-100">
							<div class="rb-object-frame">
								<div class="orb-photo-frame orb-obj-1 orb-active">
									<div class="swiper-container orb-slideshow swiper-container-fade swiper-container-horizontal">
										<div class="swiper-wrapper" style="transition-duration: 0ms;">
											<div class="swiper-slide" style="width: 772px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
												<img src="img/photo/30.jpg" alt="photo" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" style="opacity: 0; transform: translate3d(100px, 0px, 0px) scale(1.3); transition-duration: 0ms;">
											</div>
											<div class="swiper-slide swiper-slide-prev" style="width: 772px; opacity: 1; transform: translate3d(-772px, 0px, 0px); transition-duration: 0ms;">
												<img src="img/photo/20.jpg" alt="photo" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" style="opacity: 0; transform: translate3d(100px, 0px, 0px) scale(1.3); transition-duration: 0ms;">
											</div>
											<div class="swiper-slide swiper-slide-active" style="width: 772px; opacity: 1; transform: translate3d(-1544px, 0px, 0px); transition-duration: 0ms;">
												<img src="img/photo/23.jpg" alt="photo" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale(1); transition-duration: 0ms;">
											</div>
											<div class="swiper-slide swiper-slide-next" style="width: 772px; opacity: 0; transform: translate3d(-2316px, 0px, 0px); transition-duration: 0ms;">
												<img src="img/photo/31.jpg" alt="photo" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" style="opacity: 0; transform: translate3d(-100px, 0px, 0px) scale(1.3); transition-duration: 0ms;">
											</div>
											<div class="swiper-slide" style="width: 772px; opacity: 0; transform: translate3d(-3088px, 0px, 0px); transition-duration: 0ms;">
												<img src="img/photo/32.jpg" alt="photo" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" style="opacity: 0; transform: translate3d(-100px, 0px, 0px) scale(1.3); transition-duration: 0ms;">
											</div>
											<div class="swiper-slide" style="width: 772px; opacity: 0; transform: translate3d(-3860px, 0px, 0px); transition-duration: 0ms;">
												<img src="img/photo/33.jpg" alt="photo" data-swiper-parallax-x="100" data-swiper-parallax-scale="1.3" data-swiper-parallax-opacity="0" data-swiper-parallax-duration="1200" style="opacity: 0; transform: translate3d(-100px, 0px, 0px) scale(1.3); transition-duration: 0ms;">
											</div>
										</div>
								...
								<div class="orb-slide-caption">
									<span class="orb-suptitle">Professional <br>photographer</span>
									<h1><span>Anastasia&nbsp; <br>Chazova&nbsp; </span></h1>
								</div>
							</div>
						</div>
					</div>
					<div class="orb-navigation">
						<div class="orb-pagination swiper-pagination-fraction"><span class="swiper-pagination-current">3</span> / <span class="swiper-pagination-total">6</span></div>
